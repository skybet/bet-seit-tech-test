...
const url = "https://notrealplantshop.com/"
...
test('Can get to reviews of site', async ({page}) => {
  ...
  expect(page.url()).toBe("https://trustpilot.com/reviews/notrealplantshop")
  await expect(page).toHaveTitle('Not Real Plant Shop')
