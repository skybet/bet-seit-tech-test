...
* Pull the repository and make comments alongside the code
...
These test are for an ecommerce site using the React front-end framework, which sells plants.
However the site is entirely fictional (i.e. it does not exist) and as a result these tests cannot actually be run.
We want you to only look at the code, and assess it as you would any test suite.
